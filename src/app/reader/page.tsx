...
import React, { Suspense, useState, useEffect, useCallback, useRef, useMemo, useContext } from 'react';
...
export default function ReaderPage() {
  return <Suspense fallback={<div className="flex h-screen items-center justify-center">Loading reader…</div>}><ReaderPageContent /></Suspense>;
}
