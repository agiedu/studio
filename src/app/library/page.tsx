...
export default function LibraryPage() {
  ...
  const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // This Server Action attempts to send the file to your local helper service.
      ...
      if (localUploadResult.success && localUploadResult.filePath) {
        ...
        // If localUploadResult.message is already detailed, use it.
        const description = localUploadResult.message || "Could not save to local device. Ensure the helper service is running and check its console.";
      ...
      // This catch block handles errors if the Server Action call itself fails unexpectedly (e.g., network issue to Next.js server)
    ...
    <div className="container mx-auto p-4 md:p-6 space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            All uploaded files are sent directly to the helper service.
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardContent className="space-y-3 text-sm text-destructive-foreground/90">
            ...
            <p className="font-medium">
             ...
             <ol className="list-decimal pl-5 space-y-1.5">
                ...
                <li><strong>CHECK ITS CONSOLE OUTPUT:</strong> Look at the terminal output of your helper service. It should clearly indicate that it's running and listening on port 3001 (or similar). Check for any error messages there. <strong className="text-destructive-foreground">This is the most important step for debugging.</strong></li>
                <li><strong>VERIFY URL & PORT:</strong> Confirm your helper service is configured to listen for uploads at `http://localhost:3001/upload`.</li>
                ...
                <li><strong>CHECK NEXT.JS CONSOLE:</strong> Also check the console where you run MangaTalk (`npm run dev`) for detailed error messages from the Server Action.</li>
            </ol>
            <p className="mt-3">
            ...
            <p>
                For reading documents within this application during your current session, please use the &quot;Read2&quot; page to upload them. Uploaded files there are also attempted to be sent to your local helper service for persistent storage.
            </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-3 text-sm text-muted-foreground">
            <p>
                If your local helper service is unavailable or you prefer a different method for quick, temporary saves, you can manually save content displayed in the MangaTalk application using your browser's built-in features:
            </p>
             <ul className="list-disc pl-5 space-y-1">
                <li><strong>Save Page As:</strong> For web pages or rendered content, you can often right-click and select "Save Page As..." or use your browser's menu (File &gt; Save Page As...).</li>
            ...
            <p className="font-medium mt-2">
                Note: These manual methods are workarounds and do not involve the MangaTalk application's designed local saving feature, which relies on the **operational local helper service.**
            </p>
        </CardContent>
      </Card>
